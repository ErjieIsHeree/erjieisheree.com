...
import { Typography, Button, Grid, Card, CardContent, CardMedia, Link, Divider } from "@mui/material";

export default function Home() {
  return (
    <Grid container spacing={7} sx={{ px: 10, py: 7 }}>
      <Grid size={12}>
        <Divider />
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Card>
                  ...
                  <CardContent>
                    ...
                    <br />
                    <Link href="/devlog" underline="none">
                      See more
                    </Link>
                  </CardContent>
                </Card>
