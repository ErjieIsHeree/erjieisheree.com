...
function renderPost(
  ...
  return(
    <Link key={post.id} href={`/devlog/${post.id}`} justifyContent={"space-between"} underline='none'
      sx={{
        width: '100%',
  ...
  return (
    <Grid container spacing={4}>
      <Grid container spacing={3} size={12}>
        ...
        <Grid size={12}>
          <Typography variant="subtitle1" color="text.primary">Welcome to mi studies/works blocs notes.<br />Here you&#39;ll find everything about my background as an IT professional.</Typography>
        </Grid>
      </Grid>
